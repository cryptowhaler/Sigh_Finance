...
export default {
  ...
  methods: {
    ...
    displayWelcomeMessage() {
        ...
        this.$showInfoMsg({title: 'Onboarding Info :' ,message:"The protocol is currently Live on Binance Smart Chain's testnet. Please connect to the KOVAN Network or the BSC's test network to interact with SIGH Finance!" });
    },
