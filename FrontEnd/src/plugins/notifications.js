...
const notificationComponent = new Vue({
  name: 'MyComponent',
  notifications: {
    showSuccessMsg: { type: VueNotifications.types.success, title: 'Success',message: 'It worked!',},
    showInfoMsg: {type: VueNotifications.types.info, title: 'Info', message: 'Nice to meet you.', },
    showWarnMsg: { type: VueNotifications.types.warn, title: 'Warning', message: 'BEWARE',},
    showErrorMsg: { type: VueNotifications.types.error, title: 'Error', message: 'Something went wrong.',},
  },
});
