...
import { AccountCToken, Account } from '../generated/schema'
...
// The Relationship between user and a Market
export function createAccountCToken(cTokenStatsID: string, symbol: string,account: string,marketID: string,): AccountCToken {
...
export function updateCommonCTokenStats(marketID: string,marketSymbol: string,accountID: string,txHash: Bytes,timestamp: i32,blockNumber: i32,): AccountCToken {
