...
export class Sightroller__gsighSupplyStateResult {
  value0: BigInt;
  value1: BigInt;
...
export class Sightroller__marketsResult {
  value0: boolean;
  value1: BigInt;
  value2: boolean;
  value3: boolean;
...
export class Sightroller__getAccountLiquidityResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Sightroller__getHypotheticalAccountLiquidityResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Sightroller__liquidateCalculateSeizeTokensResult {
  value0: BigInt;
  value1: BigInt;
...
export class Sightroller extends ethereum.SmartContract {
  ...
  try_gsighAccrued(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "gsighAccrued",
      "gsighAccrued(address):(uint256)",
      [ethereum.Value.fromAddress(param0)]
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  gsighBorrowState(param0: Address): Sightroller__gsighBorrowStateResult {
    let result = super.call(
      "gsighBorrowState",
      "gsighBorrowState(address):(uint224,uint32)",
      [ethereum.Value.fromAddress(param0)]
    );

    return new Sightroller__gsighBorrowStateResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_gsighBorrowState(
    param0: Address
  ): ethereum.CallResult<Sightroller__gsighBorrowStateResult> {
    let result = super.tryCall(
      "gsighBorrowState",
      "gsighBorrowState(address):(uint224,uint32)",
      [ethereum.Value.fromAddress(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new Sightroller__gsighBorrowStateResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  gsighBorrowerIndex(param0: Address, param1: Address): BigInt {
    let result = super.call(
      "gsighBorrowerIndex",
  ...
  gsighRate(): BigInt {
    let result = super.call("gsighRate", "gsighRate():(uint256)", []);

    return result[0].toBigInt();
  }

  try_gsighRate(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("gsighRate", "gsighRate():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  gsighSpeeds(param0: Address): BigInt {
    let result = super.call("gsighSpeeds", "gsighSpeeds(address):(uint256)", [
      ethereum.Value.fromAddress(param0)
    ]);
  ...
  try_gsighSpeeds(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "gsighSpeeds",
      "gsighSpeeds(address):(uint256)",
      [ethereum.Value.fromAddress(param0)]
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  gsighSupplierIndex(param0: Address, param1: Address): BigInt {
    let result = super.call(
      "gsighSupplierIndex",
      "gsighSupplierIndex(address,address):(uint256)",
      [ethereum.Value.fromAddress(param0), ethereum.Value.fromAddress(param1)]
    );
  ...
  gsighSupplyState(param0: Address): Sightroller__gsighSupplyStateResult {
    let result = super.call(
      "gsighSupplyState",
      "gsighSupplyState(address):(uint224,uint32)",
      [ethereum.Value.fromAddress(param0)]
    );

    return new Sightroller__gsighSupplyStateResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_gsighSupplyState(
    param0: Address
  ): ethereum.CallResult<Sightroller__gsighSupplyStateResult> {
    let result = super.tryCall(
      "gsighSupplyState",
      "gsighSupplyState(address):(uint224,uint32)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Sightroller__gsighSupplyStateResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  isSightroller(): boolean {
    let result = super.call("isSightroller", "isSightroller():(bool)", []);

    return result[0].toBoolean();
  }

  try_isSightroller(): ethereum.CallResult<boolean> {
    let result = super.tryCall("isSightroller", "isSightroller():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  markets(param0: Address): Sightroller__marketsResult {
    let result = super.call(
      "markets",
      "markets(address):(bool,uint256,bool,bool)",
      [ethereum.Value.fromAddress(param0)]
    );

    return new Sightroller__marketsResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBoolean(),
      result[3].toBoolean()
  ...
  try_markets(
    param0: Address
  ): ethereum.CallResult<Sightroller__marketsResult> {
    let result = super.tryCall(
      "markets",
      "markets(address):(bool,uint256,bool,bool)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Sightroller__marketsResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBoolean(),
        value[3].toBoolean()
  ...
  pendingSightrollerImplementation(): Address {
    let result = super.call(
      "pendingSightrollerImplementation",
      "pendingSightrollerImplementation():(address)",
      []
    );
  ...
  try_pendingSightrollerImplementation(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "pendingSightrollerImplementation",
      "pendingSightrollerImplementation():(address)",
      []
  ...
  sightrollerImplementation(): Address {
    let result = super.call(
      "sightrollerImplementation",
      "sightrollerImplementation():(address)",
      []
    );
  ...
  try_sightrollerImplementation(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "sightrollerImplementation",
      "sightrollerImplementation():(address)",
      []
  ...
  getAccountLiquidity(
    account: Address
  ): Sightroller__getAccountLiquidityResult {
    let result = super.call(
      "getAccountLiquidity",
    ...
    return new Sightroller__getAccountLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getAccountLiquidity(
    account: Address
  ): ethereum.CallResult<Sightroller__getAccountLiquidityResult> {
    let result = super.tryCall(
      "getAccountLiquidity",
      "getAccountLiquidity(address):(uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(account)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Sightroller__getAccountLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  getHypotheticalAccountLiquidity(
    ...
    redeemTokens: BigInt,
    borrowAmount: BigInt
  ): Sightroller__getHypotheticalAccountLiquidityResult {
    let result = super.call(
      "getHypotheticalAccountLiquidity",
    ...
    return new Sightroller__getHypotheticalAccountLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getHypotheticalAccountLiquidity(
    ...
    redeemTokens: BigInt,
    borrowAmount: BigInt
  ): ethereum.CallResult<Sightroller__getHypotheticalAccountLiquidityResult> {
    let result = super.tryCall(
      "getHypotheticalAccountLiquidity",
      "getHypotheticalAccountLiquidity(address,address,uint256,uint256):(uint256,uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Sightroller__getHypotheticalAccountLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  liquidateCalculateSeizeTokens(
  ...
  ): Sightroller__liquidateCalculateSeizeTokensResult {
    let result = super.call(
      "liquidateCalculateSeizeTokens",
    ...
    return new Sightroller__liquidateCalculateSeizeTokensResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_liquidateCalculateSeizeTokens(
    ...
    cTokenCollateral: Address,
    actualRepayAmount: BigInt
  ): ethereum.CallResult<Sightroller__liquidateCalculateSeizeTokensResult> {
    let result = super.tryCall(
      "liquidateCalculateSeizeTokens",
      "liquidateCalculateSeizeTokens(address,address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Sightroller__liquidateCalculateSeizeTokensResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
