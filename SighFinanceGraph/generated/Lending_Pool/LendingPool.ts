...
export class InstrumentUsedAsCollateralDisabled extends ethereum.Event {
  get params(): InstrumentUsedAsCollateralDisabled__Params {
    return new InstrumentUsedAsCollateralDisabled__Params(this);
  }
}

export class InstrumentUsedAsCollateralDisabled__Params {
  _event: InstrumentUsedAsCollateralDisabled;

  constructor(event: InstrumentUsedAsCollateralDisabled) {
    this._event = event;
  }
...
export class InstrumentUsedAsCollateralEnabled extends ethereum.Event {
  get params(): InstrumentUsedAsCollateralEnabled__Params {
    return new InstrumentUsedAsCollateralEnabled__Params(this);
  }
}

export class InstrumentUsedAsCollateralEnabled__Params {
  _event: InstrumentUsedAsCollateralEnabled;

  constructor(event: InstrumentUsedAsCollateralEnabled) {
    this._event = event;
  }
...
export class LendingPool__getInstrumentConfigurationDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: Address;
...
export class LendingPool__getInstrumentDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class LendingPool__getUserInstrumentDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class LendingPool extends ethereum.SmartContract {
  ...
  feeProvider(): Address {
    let result = super.call("feeProvider", "feeProvider():(address)", []);

    return result[0].toAddress();
  }

  try_feeProvider(): ethereum.CallResult<Address> {
    let result = super.tryCall("feeProvider", "feeProvider():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  getInstrumentConfigurationData(
    ...
    let result = super.call(
      "getInstrumentConfigurationData",
      "getInstrumentConfigurationData(address):(uint256,uint256,uint256,address,bool,bool,bool,bool)",
      [ethereum.Value.fromAddress(_instrument)]
    );

    return new LendingPool__getInstrumentConfigurationDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toAddress(),
  ...
  try_getInstrumentConfigurationData(
    _instrument: Address
  ): ethereum.CallResult<LendingPool__getInstrumentConfigurationDataResult> {
    let result = super.tryCall(
      "getInstrumentConfigurationData",
      "getInstrumentConfigurationData(address):(uint256,uint256,uint256,address,bool,bool,bool,bool)",
      [ethereum.Value.fromAddress(_instrument)]
    ...
    return ethereum.CallResult.fromValue(
      new LendingPool__getInstrumentConfigurationDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toAddress(),
  ...
  getInstrumentData(
    _instrument: Address
  ): LendingPool__getInstrumentDataResult {
    let result = super.call(
      "getInstrumentData",
      "getInstrumentData(address):(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,address,uint40)",
      [ethereum.Value.fromAddress(_instrument)]
    );

    return new LendingPool__getInstrumentDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getInstrumentData(
    _instrument: Address
  ): ethereum.CallResult<LendingPool__getInstrumentDataResult> {
    let result = super.tryCall(
      "getInstrumentData",
      "getInstrumentData(address):(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,address,uint40)",
      [ethereum.Value.fromAddress(_instrument)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new LendingPool__getInstrumentDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getUserInstrumentData(
    _instrument: Address,
    _user: Address
  ): LendingPool__getUserInstrumentDataResult {
    let result = super.call(
      "getUserInstrumentData",
      "getUserInstrumentData(address,address):(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,bool)",
      [
        ethereum.Value.fromAddress(_instrument),
        ethereum.Value.fromAddress(_user)
      ]
    ...
    return new LendingPool__getUserInstrumentDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getUserInstrumentData(
    _instrument: Address,
    _user: Address
  ): ethereum.CallResult<LendingPool__getUserInstrumentDataResult> {
    let result = super.tryCall(
      "getUserInstrumentData",
      "getUserInstrumentData(address,address):(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,bool)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new LendingPool__getUserInstrumentDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
