...
export class NewSightroller extends ethereum.Event {
  get params(): NewSightroller__Params {
    return new NewSightroller__Params(this);
  }
}

export class NewSightroller__Params {
  _event: NewSightroller;

  constructor(event: NewSightroller) {
    this._event = event;
  }

  get oldSightroller(): Address {
    return this._event.parameters[0].value.toAddress();
  }

  get newSightroller(): Address {
    return this._event.parameters[1].value.toAddress();
  }
}
...
export class cERC20__getAccountSnapshotResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class cERC20 extends ethereum.SmartContract {
  ...
  _setSightroller(newSightroller: Address): BigInt {
    let result = super.call(
      "_setSightroller",
      "_setSightroller(address):(uint256)",
      [ethereum.Value.fromAddress(newSightroller)]
    );

    return result[0].toBigInt();
  }

  try__setSightroller(newSightroller: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "_setSightroller",
      "_setSightroller(address):(uint256)",
      [ethereum.Value.fromAddress(newSightroller)]
  ...
  getAccountSnapshot(account: Address): cERC20__getAccountSnapshotResult {
    let result = super.call(
      "getAccountSnapshot",
    ...
    return new cERC20__getAccountSnapshotResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_getAccountSnapshot(
    account: Address
  ): ethereum.CallResult<cERC20__getAccountSnapshotResult> {
    let result = super.tryCall(
      "getAccountSnapshot",
      "getAccountSnapshot(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(account)]
    ...
    return ethereum.CallResult.fromValue(
      new cERC20__getAccountSnapshotResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  sightroller(): Address {
    let result = super.call("sightroller", "sightroller():(address)", []);

    return result[0].toAddress();
  }

  try_sightroller(): ethereum.CallResult<Address> {
    let result = super.tryCall("sightroller", "sightroller():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class _setSightrollerCall extends ethereum.Call {
  get inputs(): _setSightrollerCall__Inputs {
    return new _setSightrollerCall__Inputs(this);
  }

  get outputs(): _setSightrollerCall__Outputs {
    return new _setSightrollerCall__Outputs(this);
  }
}

export class _setSightrollerCall__Inputs {
  _call: _setSightrollerCall;

  constructor(call: _setSightrollerCall) {
    this._call = call;
  }
...
export class _setSightrollerCall__Outputs {
  _call: _setSightrollerCall;
