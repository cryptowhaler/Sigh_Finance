...
contract ComptrollerHarness is Comptroller {
    ...
    function harnesstransferGSigh(address user, uint userAccrued, uint threshold) public returns (uint) {
        return transferGSigh(user, userAccrued, threshold);
    }
...
contract BoolComptroller is SightrollerInterface {
    bool allowMint = true;
